...
import type { EmitterWebhookEvent as WebhookEvent, Webhooks } from "@octokit/webhooks";
...
export type ApplicationFunction = (app: Probot, options: ApplicationFunctionOptions) => void | Promise<void>;
...
export type OctokitOptions = NonNullable<ConstructorParameters<typeof ProbotOctokit>[0]>;
...
type ManifestPermissionScope = "actions" | "checks" | "contents" | "deployments" | "id-token" | "issues" | "discussions" | "packages" | "pages" | "pull-requests" | "repository-projects" | "security-events" | "statuses";
